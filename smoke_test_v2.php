...
if ($inboundId) {
    ...
    test("Receive", 'inbound', 'receive', ['id' => $inboundId], $token, 'POST');
    test("Putaway", 'inbound', 'putaway', ['id' => $inboundId, 'items' => [['product_id' => 13338, 'quantity' => 100, 'location_code' => 'CA01A01']]], $token, 'POST');
