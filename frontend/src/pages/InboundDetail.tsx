...
const headerActions = (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <WebBtn href={`${webBase()}/print_inbound.php?id=${order.id}&token=${getToken() || ''}`} label="Receipt" icon={<Printer className="w-4 h-4" />} />
      <WebBtn href={`${webBase()}/putaway_sheet.php?id=${order.id}&token=${getToken() || ''}`} label="Putaway" icon={<ClipboardList className="w-4 h-4" />} />
